    ...
    return {
        ...
        plugins: [
            ...
            new webpack.DefinePlugin({
                ...
                'process.env.FIREBASE_FIREBASE_APP_ID': JSON.stringify(process.env.FIREBASE_API_KEY),
                'process.env.FIREBASE_MEASUREMENT_ID': JSON.stringify(process.env.FIREBASE_API_KEY)
            })
        ],
